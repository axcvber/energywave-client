...
const SearchSelect: React.FC<ISearchSelect> = ({
  ...
  const colourStyles: StylesConfig<SelectOption> = {
    control: (styles, { isFocused }) => ({
      ...
      cursor: 'pointer',
      boxShadow: isFocused && !error ? '0 0 0 1px #5cd4ff' : 'red',
      borderColor: isFocused && !error ? '#5cd4ff' : error ? 'red' : 'inherit',
      '&:hover': {
        borderColor: isFocused && !error ? '#5cd4ff' : error ? 'red' : 'inherit',
      },
    }),
    ...
    option: (styles, { isDisabled, isFocused, isSelected }) => ({
      ...styles,
      backgroundColor: isDisabled ? undefined : isSelected ? '#00BCFF' : isFocused ? '#E5F8FF' : undefined,
      ...
      ':active': {
        ...styles[':active'],
        backgroundColor: !isDisabled ? (isSelected ? '#00A8E5' : '#CEF2FF') : undefined,
      },
    }),
